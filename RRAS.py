...
def access_data():
	...
	label=Label(root5,text="RESTAURANT REVIEW ANALYSIS SYSTEM",bd=2,font=('Arial',47,'bold','underline'))
...
def view_details(s):
	if(s!=rras_code):
		...
		sug1=Label(root4,text="Click the below button, if you want to view the data from your database....")
...
def take_review():
	...
	label=Label(root2,text="RESTAURANT REVIEW ANALYSIS SYSTEM",bd=2,font=('Arial',47,'bold','underline'))
